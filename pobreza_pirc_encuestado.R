...
base_pirc$cno12 <- str_sub(base_pirc$CNO_encuestado, 1, 2)
base_pirc$cno3 <- str_sub(base_pirc$CNO_encuestado, 3, 3)
base_pirc$cno4 <- str_sub(base_pirc$CNO_encuestado, 4, 4)
base_pirc$cno5 <- str_sub(base_pirc$CNO_encuestado, 5, 5)
...
base_pirc <- base_pirc %>% 
  mutate(categoria = case_when(M3.5 == 1 & cno3 == 0 ~ 1,
                                   M3.5 == 2 | cno3 == 1 ~ 2,
...
base_pirc$teletrabajo <- case_when(base_pirc$M5.4A_6 == 1 ~ 1,
                                   base_pirc$M5.5A_6 == 1 ~ 1,
                                   TRUE ~ 0)

base_pirc <- base_pirc %>% 
  mutate(covid_cierre_despido = case_when(M5.4A_1 == 1 | M5.4A_4 == 1 | M5.5A_1 == 1 ~ 1,
                                          TRUE ~ 0),
         covid_baja_ingresos = case_when(M5.4A_3 == 1 | M5.4A_7 == 1 | M5.5A_3 == 1 | M5.5A_5 == 1 ~ 1,
                                         TRUE ~ 0),
         covid_cambio = case_when(M5.4A_5 == 1 | M5.5A_2 == 1 | M5.5A_4 == 1 ~ 1,
                                  TRUE ~ 0))
